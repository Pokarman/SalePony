...
if not st.session_state.sesion_iniciada:
    ...
    tabs = st.tabs(["📦 ÓRDENES E-COMMERCE", "🛒 Vender o Salida de Mercancía", "👟 INVENTARIO", "📝 INGRESAR O EDITAR CATÁLOGO", "📊 REPORTES"]) if st.session_state.rol_usuario == "Administrador" else st.tabs(["📦 ÓRDENES", "🛒 TPV", "👟 INVENTARIO"])
